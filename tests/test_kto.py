...
class TestKTODataPreparation(unittest.TestCase):
            ...
            "results": [
                {
                    ...
                    "rounds": [
                        [
                            {"agent_id": "agent_1", "answer": "A", "reasoning": "Approach A is better because..."},
                            {"agent_id": "agent_2", "answer": "A", "reasoning": "I agree with A..."},
                            {"agent_id": "agent_3", "answer": "B", "reasoning": "Actually B is better..."}
                        ],
                        [
                            {"agent_id": "agent_1", "answer": "A", "reasoning": "After review, A is still best..."},
                            {"agent_id": "agent_2", "answer": "A", "reasoning": "Confirmed, A works..."},
                            {"agent_id": "agent_3", "answer": "B", "reasoning": "Still prefer B..."}
                        ]
                    ],
                    "final_consensus": {
                        "majority_answer": "A",
                ...
                },
                {
                    ...
                    "rounds": [
                        [
                            {"agent_id": "agent_1", "answer": "X", "reasoning": "Strategy X is optimal..."},
                            {"agent_id": "agent_2", "answer": "Y", "reasoning": "Strategy Y is better..."},
                            {"agent_id": "agent_3", "answer": "X", "reasoning": "X is the right choice..."}
                        ],
                        [
                ...
                },
                {
                    ...
                    "rounds": [
                        [
                            {"agent_id": "agent_1", "answer": "unclear", "reasoning": "Not sure..."},
                            {"agent_id": "agent_2", "answer": "maybe", "reasoning": "Could be either..."},
                            {"agent_id": "agent_3", "answer": "unclear", "reasoning": "Ambiguous..."}
                        ],
                        [
                            {"agent_id": "agent_1", "answer": "unclear", "reasoning": "Still unclear..."},
                            {"agent_id": "agent_2", "answer": "maybe", "reasoning": "Still ambiguous..."},
                            {"agent_id": "agent_3", "answer": "unclear", "reasoning": "Cannot decide..."}
                        ]
                    ],
                    "final_consensus": {
                        "majority_answer": "unclear",
    ...
    def test_label_assignment(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            debate_001_entries = [e for e in kto_entries if e['metadata']['debate_id'] == 'test_001']
